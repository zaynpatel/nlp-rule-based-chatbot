...
for pos_tag in pos_tagged_text:
  # chunk each sentence and append to lists here
  np_chunked_text.append(np_chunk_parser.parse(pos_tag))
  vp_chunked_text.append(vp_chunk_parser.parse(pos_tag))

# store and print the most common NP-chunks here. (NP-Chunk, Count)
